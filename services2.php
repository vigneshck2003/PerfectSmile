...
<section class="home" id="home" style="background-color: #16a085;">
    ...
    <div class="content">
        <h3 style="color:white">Kids Dentistry</h3>
</section>
<section class="heading">
    ...
    <ul class="content" style="color:#16a085">
        ...
        <li style="font-size: 1.6rem; color: #36455c;">Pediatric dentists are specially trained to provide comprehensive dental care tailored to the unique needs of young patients.</h2>
        <br>
        <br>
