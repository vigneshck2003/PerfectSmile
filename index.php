...
<section class="services" id="services">
    ...
    <div class="box-container">
        <div class="box">
            <i class="fas fa-notes-medical"><img src="dent_braces.png" alt=""></i>
        ...
        <div class="box">
            <i class="fas fa-ambulance"><img src="kids_dentistry.png" alt=""></i>
        ...
        <div class="box">
            <i class="fas fa-user-md"><img src="root_canal.png" alt=""></i>
            <h3>Root Canal Therapy</h3>
            <p>Say goodbye to tooth pain, and hello to a healthier smile! #Hello Healthy Smile</p>
            <a href="services3.php" class="btn">Learn more</a>
        </div>

        <div class="box">
            <i class="fas fa-pills"><img src="dental_implant.png" alt=""></i>
        ...
        <div class="box">
            <i class="fas fa-procedures"><img src="./dental_gum.png" alt=""></i>
            <h3>Gum Therapy</h3>
        ...
        <div class="box">
            <i class="fas fa-infection-free"><img src="teeth_whitening.png" alt=""></i>
        ...
        <div class="box">
            <i class="fas fa-infection-free"><img src="laser_dentistry.png" alt=""></i>
        ...
        <div class="box">
            <i class="fas fa-infection-free"><img src="teeth_removal.png" alt=""></i>
            <h3>Teeth Removal</h3>
...
<section class="doctors" id="doctors">
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="share">
                <a href="https://www.facebook.com" class="fab fa-facebook-f"><ion-icon name="logo-facebook"></ion-icon></a>
                <a href="https://www.twitter.com" class="fab fa-twitter-f"><ion-icon name="logo-twitter"></ion-icon></a>
                <a href="https://www.instagram.com/" class="fab fa-instagram-f"><ion-icon name="logo-instagram"></ion-icon></a>
                <a href="https://www.linkedin.com" class="fab fa-LinkedIn-f"><ion-icon name="logo-linkedin"></ion-icon></a>
            </div>
        </div>
