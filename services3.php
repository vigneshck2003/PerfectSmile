...
<section class="home" id="home" style="background-color: #16a085;">
    <div class="image">
        <img src="home-img.svg" alt="">
    </div>

    <div class="content">
        <h3 style="color:white">Root Canal</h3>
</section>
<section class="heading">
    ...
    <ul class="content" style="color:#16a085">
        ...
        <li style="font-size: 1.6rem; color: #36455c;">Root canal therapy is highly effective in relieving pain and saving teeth that would otherwise need to be extracted.</h2>
        <br>
        <br>
